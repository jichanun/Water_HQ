...
#include <string.h>
#include <math.h>
#include "driver_inv_mpu.h"
#include "driver_inv_mpu_dmp_motion_driver.h"
...
#define DelayXms    msp430_DelayXms
...
/* DelayXms is a function already defined in ASF. */
